...
source = "source"
target = "target"
fp = open("/home/zzh/Documents/networkTopology/Colt.gml", "r")
...
for node, data in compiled.items():
    ...
    fp = open("/home/zzh/nsdi22/pybatfish/jupyter_notebooks/networks/ospf-test-colt/configs/"+ node.label + ".cfg", "w")
    fp.write(rendered)
    fp.close()
    # print(rendered)
