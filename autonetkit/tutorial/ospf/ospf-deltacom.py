...
properties = {
    "r0": (250, 0, 1), "r1": (0, 250, 1), "r2": (250, 250, 1),
    "r3": (250, 0, 1), "r4": (0, 250, 1), "r5": (250, 250, 1),
    "r6": (250, 0, 1), "r7": (0, 250, 1), "r8": (250, 250, 1), "r9": (250, 250, 1),
    "r10": (250, 0, 1), "r11": (0, 250, 1), "r12": (250, 250, 1),
    "r13": (250, 0, 1), "r14": (0, 250, 1), "r15": (250, 250, 1),
    "r16": (250, 0, 1), "r17": (0, 250, 1), "r18": (250, 250, 1),
    "r19": (250, 0, 1), "r20": (0, 250, 1), "r21": (250, 250, 1),
    "r22": (250, 0, 1), "r23": (0, 250, 1), "r24": (250, 250, 1),
    "r25": (250, 0, 1), "r26": (0, 250, 1), "r27": (250, 250, 1),
    "r28": (250, 0, 1), "r29": (0, 250, 1), "r30": (250, 250, 1),
    "r31": (250, 250, 1), "r32": (250, 0, 1), "r33": (0, 250, 1),
    "r34": (250, 250, 1), "r35": (250, 0, 1), "r36": (0, 250, 1), "r37": (250, 250, 1),
    "r38": (250, 0, 1), "r39": (0, 250, 1), "r40": (250, 250, 1),
    "r41": (250, 0, 1), "r42": (0, 250, 1), "r43": (250, 250, 1),
    "r44": (250, 250, 1), "r45": (250, 250, 1), "r46": (250, 250, 1),
    "r47": (250, 250, 1), "r48": (250, 250, 1),
    "r49": (250, 0, 1), "r50": (0, 250, 1), "r51": (250, 250, 1),
    "r52": (250, 0, 1), "r53": (0, 250, 1), "r54": (250, 250, 1),
    "r55": (250, 0, 1), "r56": (0, 250, 1), "r57": (250, 250, 1), "r58": (250, 250, 1),
    "r59": (250, 0, 1), "r60": (0, 250, 1), "r61": (250, 250, 1),
    "r62": (250, 0, 1), "r63": (0, 250, 1), "r64": (250, 250, 1),
    "r65": (250, 0, 1), "r66": (0, 250, 1), "r67": (250, 250, 1),
    "r68": (250, 0, 1), "r69": (0, 250, 1), "r70": (250, 250, 1),
    "r71": (250, 0, 1), "r72": (0, 250, 1), "r73": (250, 250, 1),
    "r74": (250, 0, 1), "r75": (0, 250, 1), "r76": (250, 250, 1),
    "r77": (250, 0, 1), "r78": (0, 250, 1), "r79": (250, 250, 1),
    "r80": (250, 250, 1), "r81": (250, 0, 1), "r82": (0, 250, 1),
    "r83": (250, 250, 1), "r84": (250, 0, 1), "r85": (0, 250, 1), "r86": (250, 250, 1),
    "r87": (250, 0, 1), "r88": (0, 250, 1), "r89": (250, 250, 1),
    "r90": (250, 0, 1), "r91": (0, 250, 1), "r92": (250, 250, 1),
    "r93": (250, 250, 1), "r94": (250, 250, 1), "r95": (250, 250, 1),
    "r96": (250, 250, 1), "r97": (250, 250, 1), 
    "r98": (250, 0, 1), "r99": (0, 250, 1), "r100": (250, 250, 1),
    "r101": (250, 250, 1), "r102": (250, 250, 1), "r103": (250, 250, 1),
    "r104": (250, 250, 1), "r105": (250, 250, 1), "r106": (250, 250, 1),
    "r107": (250, 250, 1), "r108": (250, 250, 1), "r109": (250, 250, 1),
    "r110": (250, 250, 1), "r111": (250, 250, 1), "r112": (250, 250, 1),
}
...
# or in a loop
pairs = [(r[0], r[64]), (r[0], r[1]), (r[0], r[9]),
         (r[0], r[8]), (r[0], r[63]),
         (r[1], r[65]),(r[2], r[55]), (r[2], r[87]), 
         (r[3], r[88]), (r[3], r[4]), (r[3], r[45]),
         (r[3], r[86]), (r[3], r[47]), (r[4], r[86]),
         (r[4], r[5]), (r[4], r[6]), (r[4], r[7]),
         (r[5], r[46]), (r[6], r[80]), (r[6], r[81]),
         (r[6], r[62]), (r[7], r[8]), (r[8], r[86]),
         (r[8], r[63]), (r[9], r[63]), (r[10], r[16]),
         (r[10], r[104]), (r[10], r[11]), (r[10], r[13]),
         (r[11], r[16]),
         (r[11], r[104]),
         (r[11], r[13]),
         (r[12], r[19]),
...
for node, data in compiled.items():
    ...
    # fp = open("/home/zzh/nsdi22/pybatfish/jupyter_notebooks/networks/ospf-test-deltacom/configs/"+ node.label + ".cfg", "w")
    # fp.write(rendered)
    # fp.close()
    print(rendered)
