...
source = "source"
target = "target"
fp = open("/home/zzh/Documents/networkTopology/Garr201201.gml", "r")
...
for node, data in compiled.items():
    ...
    fp = open("/home/zzh/nsdi22/pybatfish/jupyter_notebooks/networks/ospf-test-garr201201/configs/"+ node.label + ".cfg", "w")
    fp.write(rendered)
    fp.close()
    # print(rendered)
